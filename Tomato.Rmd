...
ps2<-merge_samples(ps,"Juntar")  
#ps_si<-subset_samples(ps2, Ojo != "No") ############################################################################
...
print("Descomenta el rarefy, está puesto para no cagarla porque el resultado del rarefy modifica un poco las secuencias que van a blast, por lo que si sin querer le das otra vez a rarefy sacas un nuevo objeto ps_si cuyas ASVs ya no son iguales a las que se blastearon previamente")
print(n=100, sample_data(ps_si))

#del suelo "D" solo queda una muestra de rhizosfera, quizás tendría que quitar "D" del análisis, de los otros suelos al menos hay 3 rizosferas.
```
...
print("Change stress!")
plot_ordination(ps_si, ord.nmds.bray, shape="Type",color="Soil", title="Bray NMDS (Stress=0.171)")
